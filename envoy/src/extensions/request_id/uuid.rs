/*!
<https://github.com/envoyproxy/envoy/blob/main/api/envoy/extensions/request_id/uuid/v3/uuid.proto>
*/

/**
Configuration for the default UUID request ID extension which has the following behaviour:

1. Request ID is propagated using the :ref:`x-request-id
   <config_http_conn_man_headers_x-request-id>` header.

2. Request ID is a universally unique identifier [(UUID4)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)).
...
pub struct UUIDRequestIdConfig {
    ...
    */
    ...
    This defaults to true. See the :ref:`context propagation <arch_overview_tracing_context_propagation>` overview for more information.
    */
